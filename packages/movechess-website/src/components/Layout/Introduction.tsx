      ...
      <div className="w-full lg:w-1/2 float-right max-w-[1536px] lg:max-w-[768px] relative pb-32">
        <div className="md:pr-16 lg:pr-24 md:pt-16 lg:pt-32 w-full h-full mb-3">
          <div className="bg-[#212325] w-[90%] md:h-[40%] lg:h-[50%] float-right rounded-[30px] mb-5">
            ...
            <div className="text-center lg:px-12 xl:px-28 mt-5">
          ...
          <div className="bg-[#212325] w-[90%] md:h-[40%] lg:h-[50%] float-right rounded-[30px] mb-5">
            ...
            <div className="text-center lg:px-12 xl:px-24 mt-5">
              <h1 className="text-[32px] font-bold">
          ...
          <div className="bg-[#212325] w-[90%] md:h-[30%] lg:h-[30%] float-right rounded-[30px] mb-5 pb-12">
            <div className="shrink-0 flex justify-center mt-[10%]">
              <img
                className="w-[90px]"
