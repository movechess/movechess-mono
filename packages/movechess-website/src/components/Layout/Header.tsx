...
export default function Header() {
    ...
    return (
        <header className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-gray backdrop-blur-sm shadow-lg' : ''}`}>
            <div className="mx-auto px-5 md:px-9">
                <div className="flex items-center justify-between h-16 md:h-32">

                    {/* Site branding */}
                    <div className="shrink-0 mr-4 md:ml-14">
                        <img src="/images/move-chess-logo.png" alt="Hey Logo" />
                    </div>
